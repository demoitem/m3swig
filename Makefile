...
SHELL       = /bin/sh
SWIG_LIB_INSTALL = ${datarootdir}/swig/4.0.1
...
INSTALL         = /home/peter/projects/swig4/swig-4.0.1/Tools/config/install-sh -c
INSTALL_DATA    = ${INSTALL} -m 644
INSTALL_PROGRAM = ${INSTALL} -m 755
MKINSTDIRS      = /home/peter/projects/swig4/swig-4.0.1/Tools/config/install-sh -m 0755 -d
...
lib-languages = typemaps tcl perl5 python guile java mzscheme ruby php ocaml octave \
	csharp lua modula3 r go d javascript javascript/jsc \
...
dist:
	...
	@echo "Tools/mkdist.py 4.0.1 master"
	@false
